...
import cv2
from expdataloader.HeadGenLoader import RowData
...
class Infer(object):
    ...
    def evaluate(
        ...
        source_image,
        driver_image,
        neutral_pose: bool = False,
        source_information_for_reuse: dict = None,
        crop_center=False,
    ):
...
class ROMELoader(RowDataLoader):
    def __init__(self, name="ROME"):
        super().__init__(name)
